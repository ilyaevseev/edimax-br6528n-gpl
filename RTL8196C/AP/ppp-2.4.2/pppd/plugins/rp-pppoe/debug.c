...
"$Id: debug.c,v 1.1.1.1 2004/08/12 10:33:31 ysc Exp $";
...
#else
void inline  dumpPacket(FILE *fp, PPPoEPacket *packet, char const *dir){}
void inline  dumpHex(FILE *fp, unsigned char const *buf, int len){}
#endif
